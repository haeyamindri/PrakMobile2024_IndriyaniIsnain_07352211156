...
void main() async {
  ...
  var admin = AdminUser(name: "lila", age: 21);
  var customer = CustomerUser(name: "cika", age: 25);
  ...
  admin.addProduct(
      product1, productCatalog, productSet); // Produk tersedia dalam stok
  admin.addProduct(
      product2, productCatalog, productSet); // Produk tidak tersedia dalam stok
  admin.addProduct(
      product3, productCatalog, productSet); // Produk tersedia dalam stok
